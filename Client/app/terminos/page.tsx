          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-foreground mb-4 text-balance">
                {companyContent.termsAndConditions.title}
              </h1>
              <p className="text-muted-foreground text-lg leading-relaxed text-pretty">
                Condiciones de uso para navegar, registrarte y comprar en la plataforma INHALEX.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <article className="bg-card border border-border/60 rounded-2xl p-6 lg:p-8 shadow-sm">
                <MarkdownContent content={companyContent.termsAndConditions.content} />
              </article>
            </div>
          </div>
        </section>
