          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-foreground mb-4 text-balance">
                Ocurri&oacute; un error interno
              </h1>
              <p className="text-muted-foreground text-lg leading-relaxed text-pretty">
                Algo no sali&oacute; como esper&aacute;bamos. Puedes intentar m&aacute;s tarde o volver al inicio.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-card border border-border/60 rounded-2xl p-6 lg:p-8 shadow-sm text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  Vuelve a cargar la p&aacute;gina o navega a una secci&oacute;n principal.
                </p>
