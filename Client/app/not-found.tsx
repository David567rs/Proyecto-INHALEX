          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed text-pretty">
                Lo sentimos, la p&aacute;gina que buscas no existe o fue movida. Te ayudamos a volver a lo esencial.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-card border border-border/60 rounded-2xl p-6 lg:p-8 shadow-sm text-center">
                <h2 className="text-2xl font-semibold text-foreground mb-3">
                  &iquest;A d&oacute;nde quieres ir?
                </h2>
                <p className="text-muted-foreground mb-6">
                  Puedes regresar al inicio, descubrir productos o conocer m&aacute;s sobre INHALEX.
                </p>
