...
const OPERATION_MODULES = MODULE_CARDS.filter((module) => module.group === "operacion")
const SUPPORT_MODULES = MODULE_CARDS.filter((module) => module.group === "soporte")
...
function ModuleCard({ module }: { module: AdminModuleCard }) {
  return (
    <article className="admin-section-card flex min-h-[13.5rem] flex-col p-5">
    ...
    <section className="admin-panel-shell admin-animate-card">
      <div className="relative z-10">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-7 text-muted-foreground">
          Usa esta portada para entrar rapido a cada modulo. Dejamos juntos los flujos
          comerciales del sitio y, aparte, los modulos de control y soporte.
        </p>
            ...
            <div className="flex flex-col gap-3 border-b border-border/60 px-5 py-4 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Modulos para administrar catalogo, stock, pedidos y contenido publico.
                </p>
              </div>
              <Badge variant="secondary">{OPERATION_MODULES.length} modulos</Badge>
            </div>
          ...
          <div className="space-y-6">
            <div className="admin-form-card">
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Si vas a operar el negocio dia a dia, normalmente conviene revisar primero
                inventario y pedidos, luego productos y al final contenido si hubo cambios
                editoriales.
              </p>
              ...
              <div className="mt-5 grid gap-3">
                ...
                <div className="admin-stat-chip">
                  <span className="font-medium">4.</span> Contenido y textos legales
                </div>
              </div>
            </div>
            ...
            <div className="admin-table-shell">
              <div className="flex flex-col gap-3 border-b border-border/60 px-5 py-4 sm:flex-row sm:items-end sm:justify-between">
                ...
                <Badge variant="outline">{SUPPORT_MODULES.length} modulos</Badge>
              </div>
